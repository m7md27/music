...
async def gigshkdnnj(client, message):
    ...
    if await johned(client, message):
     return
    keybord = InlineKeyboardMarkup([[InlineKeyboardButton("تحميل صوت ⚡", callback_data=f"hidhkdhj"),InlineKeyboardButton("تحميل فديو ⚡", callback_data=f"voic54e1")], [InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ 𓃠", url=f"https://t.me/{bot_username}?startgroup=True")]])
