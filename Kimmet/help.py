...
async def changefisrt(client: Client, message):
  ...
  if message.chat.id == dev or message.chat.username in caes:
   try:
    ...
    await message.reply_text("**تم تغير اسم الحساب المساعد بنجاح ..𓃠**")
...
async def changebio(client: Client, message):
  ...
  if message.chat.id == dev or message.chat.username in caes:
   try:
    ...
    await message.reply_text("**تم تغير البايو بنجاح ..𓃠**")
   except Exception as es:
...
async def changeusername(client: Client, message):
  ...
  if message.chat.id == dev or message.chat.username in caes:
   try:
    ...
    await message.reply_text("**تم تغير اسم المستخدم بنجاح ..𓃠**")
   except Exception as es:
...
async def changephoto(client: Client, message):
  ...
  if message.chat.id == dev or message.chat.username in caes:
   try:
    ...
    await message.reply_text("**تم تغير صوره الحساب المساعد بنجاح ..𓃠**") 
   except Exception as es:
  ...
  if message.chat.id == dev or message.chat.username in caes:
       try:
        ...
        async for photos in user.get_chat_photos("me"):
         ...
         await message.reply_text("**تم ازاله صوره بنجاح ..𓃠**")
       except Exception as es:
...
async def joined(client: Client, message):
  ...
  if message.chat.id == dev or message.chat.username in caes:
   try:
    ...
    await message.reply_text("**تم انضمام الحساب المساعد بنجاح ..𓃠**")
   except Exception as es:
                ...
                try:
                 await m.pin(disable_notification=False)
                   ...
                   continue
                    ...
                    fd += 1
                    continue
     return await message.reply_text(f"**تمت الاذاعه بنجاح ..𓃠**\n\n**تمت الاذاعه الي : {dn}**\n**وفشل : {fd}**")
